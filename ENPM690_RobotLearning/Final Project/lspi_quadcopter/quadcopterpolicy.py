...
class QuadcopterPolicy(object):
    ...
    def __init__(self, basis, discount=0.98,
    ...
    def __copy__(self):
        ...
        return QuadcopterPolicy(self.basis,
                      self.discount,
                      self.explore,
                      self.weights.copy(),
    ...
    def best_action(self, state):
        ...
        if self.tie_breaking_strategy == QuadcopterPolicy.TieBreakingStrategy.FirstWins:
            return best_actions[0]
        elif self.tie_breaking_strategy == QuadcopterPolicy.TieBreakingStrategy.LastWins:
